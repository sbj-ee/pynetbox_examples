...
class NetboxManager:
    ...
    def add_site(self, name: str, slug: str, status: str = "active", **kwargs) -> Dict:
        ...
        """
        try:
            site_data = {"name": name, "slug": slug, "status": status, **kwargs}
    ...
    def add_device(
        self, name: str, device_type: int, role: int, site: int, **kwargs
    ) -> Dict:
        """
    ...
    def add_interface(
        self, device: int, name: str, type: str = "virtual", **kwargs
    ) -> Dict:
        """
        ...
        """
        try:
            interface_data = {"device": device, "name": name, "type": type, **kwargs}
    ...
    def add_ip_address(self, address: str, interface: int, **kwargs) -> Dict:
        ...
        """
        try:
            ip_data = {"address": address, "interface": interface, **kwargs}
