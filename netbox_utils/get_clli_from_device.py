...
if __name__ == "__main__":
    ...
    print(
        get_netbox_site_name(get_clli_from_device("CDCYUTEZcen02.network.teldta.com"))
    )
    print(
        get_netbox_site_name(
            get_clli_from_device("MDSNWIVU01Ndst53.network.teldta.com")
        )
    )
