...
def sync_netbox_interfaces(netbox_url: str, netbox_token: str, device_name: str, interfaces: List[Dict]) -> None:
        ...
        for intf in interfaces:
            ...
            if short_name in existing_interfaces:
                ...
                if nb_interface.description != description:
                    ...
                    nb_interface.save()
                    logger.info(f"Updated interface {short_name} description to '{description}'")
            else:
