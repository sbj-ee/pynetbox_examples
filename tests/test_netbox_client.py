...
def test_add_interface_to_device(netbox_client):
    ...
    assert netbox_client.add_interface_to_device("Eth1", "DevA", "virtual", "Desc") is True
...
def test_add_ip_to_interface(netbox_client):
    ...
    assert netbox_client.add_ip_to_interface("Dev", "Intf", "1.1.1.1/32", "active", "Desc") is True
